...
final List<Item> rest = [
  ...
  Item(
      ...
      is_favorited: false,
      price: "200 Dh",
      name: "Mixed-grill & frites maison (cotielettes d'agneeau,poulet,bœuf,merguez,viande hachée",
      description: "jus de citron,Eau gazeuse",
      sources:
      "Mixed-grill & french fries (Lamb chops,chicken,beef sausage,minced meat",
      delivery_fee: "",
      rate: "4.3",
      rate_number: ""),
  Item(
  ...
  Item(
      ...
      price: "170 Dh",
      name:
      "Sole de petit bateau facon grenobloise,riz sauté.",
      description: "jus de citron,Eau gazeuse",
      sources:
      "Grenoble style Sole served with sauteed rice .",
      delivery_fee: "",
      rate: "4.3",
      rate_number: ""),
  Item(
